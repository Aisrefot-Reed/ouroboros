...
_MODEL_PRICING_STATIC = {
    ...
    "google/gemini-2.0-pro-exp-02-05": (1.25, 0.125, 10.0),
    "google/gemini-2.0-flash": (0.10, 0.01, 0.40),
    "google/gemini-2.0-flash-thinking-exp": (2.0, 0.20, 12.0),
        ...
        while True:
            ...
            if msg is None:
                ...
                fallback_list_raw = os.environ.get(
                    ...
                    "google/gemini-2.0-pro-exp-02-05,openai/o3,anthropic/claude-sonnet-4.6"
                )
